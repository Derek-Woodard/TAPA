...
% Simulation = 'GaussianTwoCarRCLin';
% Simulation = 'GaussianTwoCarRCExp';
Simulation = 'PNJctEqBiasLin';
...
elseif strcmp(Simulation,'GaussianTwoCarRCLin')
    eval('SetGaussian2CarParasRCOnlyLin');  
elseif strcmp(Simulation,'GaussianTwoCarRCExp')
    eval('SetGaussian2CarParasRCOnlyExp');
elseif strcmp(Simulation,'PNJctEqBiasLin')
    eval('SetPNJctParasEqBCBiasLin');
end
